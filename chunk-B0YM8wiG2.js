import{$n as gm,Ci as z1,Ct as Ow,F as Fw,Fn as cn,G as He$1,Gn as ev,Gr as q1,Gt as Tt,Hn as du,Ir as ng,Jt as V,Kr as qh,L as G1,Mr as ml,Nr as mw,On as bh,Pn as cg,Qn as gl,Vt as Sh,Yn as gE,Yr as rg,Z as Iv,_i as yi,a as $h,br as kr,c as Ah,ct as Mr,er as gr,fn as Z,ft as N,ii as vc,kr as mT,kt as Pw,li as w,mn as ZD,mt as Nd,ni as ue,on as Xh,p as Bh,rn as We,rt as Ki,tn as WD,tr as gw,tt as Js,vi as yl,vr as ki,vt as Og,wr as lg,xn as _t,xr as kw}from"./chunk-v7JfcvWu.js";import{E as ki$1,H as ze,P as pe,S as ge,b as at,d as P,t as Ai}from"./chunk-CnJWgBXL.js";import{Lt as Yt,Pt as N$1,Ut as gi,nt as p,un as xt}from"./main-6MAOTFWF.js";var R=new N(`CdkAccordion`);var fe=(()=>{class t{_stateChanges=new Z;_openCloseAllActions=new Z;id=w(ge).getId(`cdk-accordion-`);multi=!1;openAll(){this.multi&&this._openCloseAllActions.next(!0)}closeAll(){this._openCloseAllActions.next(!1)}ngOnChanges(e){this._stateChanges.next(e)}ngOnDestroy(){this._stateChanges.complete(),this._openCloseAllActions.complete()}static ɵfac=function(n){return new(n||t)};static ɵdir=ZD({type:t,selectors:[[`cdk-accordion`],[``,`cdkAccordion`,``]],inputs:{multi:[2,`multi`,`multi`,G1]},exportAs:[`cdkAccordion`],features:[mT([{provide:R,useExisting:t}]),ev]})}return t})();var be=(()=>{class t{accordion=w(R,{optional:!0,skipSelf:!0});_changeDetectorRef=w(q1);_expansionDispatcher=w(p);_openCloseAllSubscription=V.EMPTY;closed=new We;opened=new We;destroyed=new We;expandedChange=new We;id=w(ge).getId(`cdk-accordion-child-`);get expanded(){return this._expanded}set expanded(e){if(this._expanded!==e){if(this._expanded=e,this.expandedChange.emit(e),e){this.opened.emit();let n=this.accordion?this.accordion.id:this.id;this._expansionDispatcher.notify(this.id,n)}else this.closed.emit();this._changeDetectorRef.markForCheck()}}_expanded=!1;get disabled(){return this._disabled()}set disabled(e){this._disabled.set(e)}_disabled=He$1(!1);_removeUniqueSelectionListener=()=>{};ngOnInit(){this._removeUniqueSelectionListener=this._expansionDispatcher.listen((e,n)=>{this.accordion&&!this.accordion.multi&&this.accordion.id===n&&this.id!==e&&(this.expanded=!1)}),this.accordion&&(this._openCloseAllSubscription=this._subscribeToOpenCloseAllActions())}ngOnDestroy(){this.opened.complete(),this.closed.complete(),this.destroyed.emit(),this.destroyed.complete(),this._removeUniqueSelectionListener(),this._openCloseAllSubscription.unsubscribe()}toggle(){this.disabled||(this.expanded=!this.expanded)}close(){this.disabled||(this.expanded=!1)}open(){this.disabled||(this.expanded=!0)}_subscribeToOpenCloseAllActions(){return this.accordion._openCloseAllActions.subscribe(e=>{this.disabled||(this.expanded=e)})}static ɵfac=function(n){return new(n||t)};static ɵdir=ZD({type:t,selectors:[[`cdk-accordion-item`],[``,`cdkAccordionItem`,``]],inputs:{expanded:[2,`expanded`,`expanded`,G1],disabled:[2,`disabled`,`disabled`,G1]},outputs:{closed:`closed`,opened:`opened`,destroyed:`destroyed`,expandedChange:`expandedChange`},exportAs:[`cdkAccordionItem`],features:[mT([{provide:R,useValue:void 0}])]})}return t})();var _e=(()=>{class t{static ɵfac=function(n){return new(n||t)};static ɵmod=bh({type:t});static ɵinj=Js({})}return t})();var Ne=[`body`];var Me=[`bodyWrapper`];var Ae=[[[`mat-expansion-panel-header`]],`*`,[[`mat-action-row`]]];var De=[`mat-expansion-panel-header`,`*`,`mat-action-row`];function Pe(t,we){}var ke=[[[`mat-panel-title`]],[[`mat-panel-description`]],`*`];var Te=[`mat-panel-title`,`mat-panel-description`,`*`];function Ie(t,we){t&1&&(ml(0,`span`,1),Nd(),ml(1,`svg`,2),qh(2,`path`,3),yl()())}var j=new N(`MAT_ACCORDION`);var ye=new N(`MAT_EXPANSION_PANEL`);var He=(()=>{class t{_template=w(Mr);_expansionPanel=w(ye,{optional:!0});static ɵfac=function(n){return new(n||t)};static ɵdir=ZD({type:t,selectors:[[`ng-template`,`matExpansionPanelContent`,``]]})}return t})();var ve=new N(`MAT_EXPANSION_PANEL_DEFAULT_OPTIONS`);var Oe=(()=>{class t extends be{_viewContainerRef=w(Ki);_animationsDisabled=Ai();_document=w(gr);_ngZone=w(ue);_elementRef=w(kr);_renderer=w(vc);_cleanupTransitionEnd;get hideToggle(){return this._hideToggle||this.accordion&&this.accordion.hideToggle}set hideToggle(e){this._hideToggle=e}_hideToggle=!1;get togglePosition(){return this._togglePosition||this.accordion&&this.accordion.togglePosition}set togglePosition(e){this._togglePosition=e}_togglePosition;afterExpand=new We;afterCollapse=new We;_inputChanges=new Z;accordion=w(j,{optional:!0,skipSelf:!0});_lazyContent;_body;_bodyWrapper;_portal;_headerId=w(ge).getId(`mat-expansion-panel-header-`);constructor(){super();let e=w(ve,{optional:!0});this._expansionDispatcher=w(p),e&&(this.hideToggle=e.hideToggle)}_hasSpacing(){return this.accordion?this.expanded&&this.accordion.displayMode==="default":!1}_getExpandedState(){return this.expanded?`expanded`:`collapsed`}toggle(){this.expanded=!this.expanded}close(){this.expanded=!1}open(){this.expanded=!0}ngAfterContentInit(){this._lazyContent&&this._lazyContent._expansionPanel===this&&this.opened.pipe(du(null),cn(()=>this.expanded&&!this._portal),_t(1)).subscribe(()=>{this._portal=new N$1(this._lazyContent._template,this._viewContainerRef)}),this._setupAnimationEvents()}ngOnChanges(e){this._inputChanges.next(e)}ngOnDestroy(){super.ngOnDestroy(),this._cleanupTransitionEnd?.(),this._inputChanges.complete()}_containsFocus(){if(this._body){let e=this._document.activeElement,n=this._body.nativeElement;return e===n||n.contains(e)}return!1}_transitionEndListener=({target:e,propertyName:n})=>{e===this._bodyWrapper?.nativeElement&&n===`grid-template-rows`&&this._ngZone.run(()=>{this.expanded?this.afterExpand.emit():this.afterCollapse.emit()})};_setupAnimationEvents(){this._ngZone.runOutsideAngular(()=>{this._animationsDisabled?(this.opened.subscribe(()=>this._ngZone.run(()=>this.afterExpand.emit())),this.closed.subscribe(()=>this._ngZone.run(()=>this.afterCollapse.emit()))):setTimeout(()=>{let e=this._elementRef.nativeElement;this._cleanupTransitionEnd=this._renderer.listen(e,`transitionend`,this._transitionEndListener),e.classList.add(`mat-expansion-panel-animations-enabled`)},200)})}static ɵfac=function(n){return new(n||t)};static ɵcmp=WD({type:t,selectors:[[`mat-expansion-panel`]],contentQueries:function(n,a,r){if(n&1&&ng(r,He,5),n&2){let o;Pw(o=Fw())&&(a._lazyContent=o.first)}},viewQuery:function(n,a){if(n&1&&rg(Ne,5)(Me,5),n&2){let r;Pw(r=Fw())&&(a._body=r.first),Pw(r=Fw())&&(a._bodyWrapper=r.first)}},hostAttrs:[1,`mat-expansion-panel`],hostVars:4,hostBindings:function(n,a){n&2&&lg(`mat-expanded`,a.expanded)(`mat-expansion-panel-spacing`,a._hasSpacing())},inputs:{hideToggle:[2,`hideToggle`,`hideToggle`,G1],togglePosition:`togglePosition`},outputs:{afterExpand:`afterExpand`,afterCollapse:`afterCollapse`},exportAs:[`matExpansionPanel`],features:[mT([{provide:j,useValue:void 0},{provide:ye,useExisting:t}]),Sh,ev],ngContentSelectors:De,decls:9,vars:4,consts:[[`bodyWrapper`,``],[`body`,``],[1,`mat-expansion-panel-content-wrapper`],[`role`,`region`,1,`mat-expansion-panel-content`,3,`id`],[1,`mat-expansion-panel-body`],[3,`cdkPortalOutlet`]],template:function(n,a){n&1&&(kw(Ae),Ow(0),ki(1,`div`,2,0)(3,`div`,3,1)(5,`div`,4),Ow(6,1),Ah(7,Pe,0,0,`ng-template`,5),gl(),Ow(8,2),gl()()),n&2&&(gE(),Bh(`inert`,a.expanded?null:``),gE(2),$h(`id`,a.id),Bh(`aria-labelledby`,a._headerId),gE(4),$h(`cdkPortalOutlet`,a._portal))},dependencies:[gi],styles:[`.mat-expansion-panel {
...
`],encapsulation:2})}return t})();var Fe=(()=>{class t{panel=w(Oe,{host:!0});_element=w(kr);_focusMonitor=w(at);_changeDetectorRef=w(q1);_parentChangeSubscription=V.EMPTY;constructor(){w(P).load(xt);let e=this.panel,n=w(ve,{optional:!0}),a=w(new Og(`tabindex`),{optional:!0}),r=e.accordion?e.accordion._stateChanges.pipe(cn(o=>!!(o.hideToggle||o.togglePosition))):Tt;this.tabIndex=parseInt(a||``)||0,this._parentChangeSubscription=gm(e.opened,e.closed,r,e._inputChanges.pipe(cn(o=>!!(o.hideToggle||o.disabled||o.togglePosition)))).subscribe(()=>this._changeDetectorRef.markForCheck()),e.closed.pipe(cn(()=>e._containsFocus())).subscribe(()=>this._focusMonitor.focusVia(this._element,`program`)),n&&(this.expandedHeight=n.expandedHeight,this.collapsedHeight=n.collapsedHeight)}expandedHeight;collapsedHeight;tabIndex=0;get disabled(){return this.panel.disabled}_toggle(){this.disabled||this.panel.toggle()}_isExpanded(){return this.panel.expanded}_getExpandedState(){return this.panel._getExpandedState()}_getPanelId(){return this.panel.id}_getTogglePosition(){return this.panel.togglePosition}_showToggle(){return!this.panel.hideToggle&&!this.panel.disabled}_getHeaderHeight(){let e=this._isExpanded();return e&&this.expandedHeight?this.expandedHeight:!e&&this.collapsedHeight?this.collapsedHeight:null}_keydown(e){switch(e.keyCode){case 32:case 13:ze(e)||(e.preventDefault(),this._toggle());break;default:this.panel.accordion&&this.panel.accordion._handleHeaderKeydown(e);return}}focus(e,n){e?this._focusMonitor.focusVia(this._element,e,n):this._element.nativeElement.focus(n)}ngAfterViewInit(){this._focusMonitor.monitor(this._element).subscribe(e=>{e&&this.panel.accordion&&this.panel.accordion._handleHeaderFocus(this)})}ngOnDestroy(){this._parentChangeSubscription.unsubscribe(),this._focusMonitor.stopMonitoring(this._element)}static ɵfac=function(n){return new(n||t)};static ɵcmp=WD({type:t,selectors:[[`mat-expansion-panel-header`]],hostAttrs:[`role`,`button`,1,`mat-expansion-panel-header`,`mat-focus-indicator`],hostVars:13,hostBindings:function(n,a){n&1&&Xh(`click`,function(){return a._toggle()})(`keydown`,function(o){return a._keydown(o)}),n&2&&(Bh(`id`,a.panel._headerId)(`tabindex`,a.disabled?-1:a.tabIndex)(`aria-controls`,a._getPanelId())(`aria-expanded`,a._isExpanded())(`aria-disabled`,a.panel.disabled),cg(`height`,a._getHeaderHeight()),lg(`mat-expanded`,a._isExpanded())(`mat-expansion-toggle-indicator-after`,a._getTogglePosition()===`after`)(`mat-expansion-toggle-indicator-before`,a._getTogglePosition()===`before`))},inputs:{expandedHeight:`expandedHeight`,collapsedHeight:`collapsedHeight`,tabIndex:[2,`tabIndex`,`tabIndex`,e=>e==null?0:z1(e)]},ngContentSelectors:Te,decls:5,vars:3,consts:[[1,`mat-content`],[1,`mat-expansion-indicator`],[`xmlns`,`http://www.w3.org/2000/svg`,`viewBox`,`0 -960 960 960`,`aria-hidden`,`true`,`focusable`,`false`],[`d`,`M480-345 240-585l56-56 184 184 184-184 56 56-240 240Z`]],template:function(n,a){n&1&&(kw(ke),ml(0,`span`,0),Ow(1),Ow(2,1),Ow(3,2),yl(),gw(4,Ie,3,0,`span`,1)),n&2&&(lg(`mat-content-hide-toggle`,!a._showToggle()),gE(4),mw(a._showToggle()?4:-1))},styles:[`.mat-expansion-panel-header {
  display: flex;
  flex-direction: row;
  align-items: center;
  padding: 0 24px;
