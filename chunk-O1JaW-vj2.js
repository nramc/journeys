...
`],encapsulation:2,changeDetection:1})}return a})();var Tt=class{index;tab};var gn=(a,s)=>s.data?.src;function vn(a,s){a&1&&aT(0,` YouTube `)}function yn(a,s){a&1&&aT(0,` Video `)}function Cn(a,s){if(a&1&&(ki(0,`span`,5),gw(1,vn,1,0)(2,yn,1,0),gl()),a&2){let t=Aw().$implicit,e=Aw();gE(),mw(t.type===e.GalleryItemTypes.Youtube?1:2)}}function xn(a,s){if(a&1&&(ki(0,`div`,1),Uh(1,`img`,4),gw(2,Cn,3,1,`span`,5),gl()),a&2){let t=s.$implicit,e=s.$index,n=Aw();$h(`lightbox`,e)(`gallery`,n.galleryId()),gE(),$h(`src`,t.type===n.GalleryItemTypes.Image?t.data?.src:t.data?.thumb??`assets/image/default-video-thumbnail.png`,pp)(`matTooltip`,t.data?.args?.title),gE(),mw(t.type!==n.GalleryItemTypes.Image?2:-1)}}function Tn(a,s){a&1&&(ki(0,`p`,2),aT(1,` No media available for this journey. `),gl())}function kn(a,s){if(a&1&&(vl(0),ki(1,`div`,6)(2,`p`,7),aT(3),gl()(),Ji()),a&2){let t=s.$implicit;gE(3),mg(t?.args?.title)}}var Oe=(()=>{class a{constructor(){this.GalleryItemTypes=z,this.galleryId=j1(`myLightbox`),this.images=j1(new l),this.videos=j1([]),this.galleryImageDef=H1.required(In$2),this.gallery=w(Y),this.items=V1([]),this.galleryConfig={loadingStrategy:`lazy`}}ngOnInit(){this.items.set(this.getGalleryItems()),this.gallery.ref(this.galleryId(),q({imageTemplate:this.galleryImageDef().templateRef},this.galleryConfig)).load(this.items())}getGalleryItems(){let t=new Array;return this.getImageItems()?.map(e=>t.push(e)),this.getVideoItems()?.map(e=>t.push(e)),t}getImageItems(){return this.images()?.images.map(t=>({type:z.Image,data:{src:t.url,thumb:t.url,args:{title:t.title,isThumbnail:t.isThumbnail}}}))}getVideoItems(){return this.videos()?.map(t=>this.isItYoutubeVideoId(t)?this.newYoutubeItem(t):this.newVideoItem(t))}isItYoutubeVideoId(t){return!t.includes(`.`)&&!t.includes(`/`)}newYoutubeItem(t){return{type:z.Youtube,data:{src:`https://www.youtube.com/embed/${t}`,thumb:`https://img.youtube.com/vi/${t}/0.jpg`,params:{loop:1,playlist:t,rel:0,controls:1}}}}newVideoItem(t){return{type:z.Iframe,data:{src:t,thumb:`assets/image/default-video-thumbnail.png`}}}static{this.ɵfac=function(e){return new(e||a)}}static{this.ɵcmp=WD({type:a,selectors:[[`app-media-gallery`]],viewQuery:function(e,n){e&1&&ig(n.galleryImageDef,In$2,5),e&2&&jw()},inputs:{galleryId:[1,`galleryId`],images:[1,`images`],videos:[1,`videos`],items:[1,`items`]},outputs:{items:`itemsChange`},decls:5,vars:1,consts:[[1,`flex`,`flex-wrap`,`grow`,`mt-2`,`me-0`,`gap-2`,`justify-center`],[1,`mb-1`,`text-center`,`rounded-lg`,`overflow-hidden`,`shadow-lg`,`border`,`border-gray-300`,3,`lightbox`,`gallery`],[1,`text-gray-500`,`italic`],[4,`galleryImageDef`],[`height`,`200`,`width`,`200`,`alt`,`media`,`loading`,`lazy`,1,`journey-image-thumbnail`,3,`src`,`matTooltip`],[1,`video-tag`],[1,`h-full`,`w-full`,`text-end`,`flex`,`flex-col`,`justify-end`],[1,`text-center`]],template:function(e,n){e&1&&(ki(0,`div`,0),vw(1,xn,3,5,`div`,1,gn,!1,Tn,2,0,`p`,2),gl(),Ah(4,kn,4,1,`ng-container`,3)),e&2&&(gE(),Iw(n.items()))},dependencies:[Lr,In$2,Gr,Yt,mt],styles:[`.journey-image-thumbnail[_ngcontent-%COMP%]{object-fit:fill}.mb-1.text-center.rounded-lg.overflow-hidden.shadow-lg.border.border-gray-300[_ngcontent-%COMP%]{position:relative}.video-tag[_ngcontent-%COMP%]{position:absolute;bottom:8px;right:8px;background:#ffffffb3;color:#4b5563;padding:4px 10px;border-radius:12px;font-size:11px;font-weight:500;-webkit-backdrop-filter:blur(4px);backdrop-filter:blur(4px)}`]})}}return a})();function In(a,s){if(a&1&&(ki(0,`span`,4),aT(1),gl()),a&2){let t=s.$implicit;gE(),Dl(` `,t,` `)}}var Ge=(()=>{class a{constructor(){this.journey=j1.required()}static{this.ɵfac=function(e){return new(e||a)}}static{this.ɵcmp=WD({type:a,selectors:[[`app-view-journey-basic-details`]],inputs:{journey:[1,`journey`]},decls:6,vars:3,consts:[[1,`mt-4`],[1,`min-h-[50vh]`],[3,`title`,`markdownText`,`journeyDate`],[1,`mt-4`,`flex`,`flex-wrap`,`gap-2`],[1,`badge`,`rounded-full`,`border`,`border-primary`,`text-primary`,`px-3`,`py-1`,`shadow-sm`]],template:function(e,n){e&1&&(ki(0,`div`,0)(1,`div`,1),Uh(2,`app-display-markdown-component`,2),gl(),ki(3,`div`,3),vw(4,In,2,1,`span`,4,yw),gl()()),e&2&&(gE(2),$h(`title`,n.journey().geoDetails?.title??``)(`markdownText`,n.journey().description)(`journeyDate`,n.journey().journeyDate),gE(2),Iw(n.journey().tags))},dependencies:[er,pe$1],encapsulation:2})}}return a})();function wn(a,s){a&1&&(ki(0,`mat-icon`,6),aT(1,`check_circle`),gl())}function Sn(a,s){a&1&&(ki(0,`mat-icon`,7),aT(1,`remove_circle`),gl())}function Dn(a,s){if(a&1){let t=Cw();ki(0,`button`,10),Xh(`click`,function(){gd(t);return md(Aw().editJourney())}),ki(1,`mat-icon`),aT(2,`edit`),gl(),ki(3,`span`),aT(4,`Edit journey`),gl()()}}var ze=(()=>{class a{constructor(){this.router=w(ue$1),this.journey=j1.required()}editJourney(){this.router.navigate([`/journey`,this.journey().id,`edit`]).then()}viewInTimeline(){this.router.navigate([`/timeline`],{queryParams:{id:this.journey().id,autoplay:`true`}}).then()}async shareJourney(){let t=this.journey(),e={title:t.name,text:`Explore my journey: ${t.name}`,url:window.location.href};if(navigator.share){await navigator.share(e);return}await navigator.clipboard.writeText(e.url)}static{this.ɵfac=function(e){return new(e||a)}}static{this.ɵcmp=WD({type:a,selectors:[[`app-view-journey-header`]],inputs:{journey:[1,`journey`]},decls:26,vars:7,consts:[[`journeyActionsMenu`,`matMenu`],[1,`flex`,`flex-col`,`md:flex-row`,`items-center`,`gap-4`],[1,`text-sm`,`text-primary`,`border-2`,`border-gradient-primary`,`badge`,`rounded-md`,`px-2`,`py-1`],[1,`journey-date`],[1,`flex`,`flex-row`,`items-center`,`gap-1`],[1,`text-lg`,`font-semibold`,`text-center`],[`matTooltip`,`Published`,1,`text-success!`,`!overflow-visible`],[`matTooltip`,`Not Published`,1,`text-warning!`,`!overflow-visible`],[`mat-icon-button`,``,`aria-label`,`Journey actions`,`matTooltip`,`Journey actions`,3,`matMenuTriggerFor`],[`mat-menu-item`,``,3,`click`,4,`appHasWriteAccess`],[`mat-menu-item`,``,3,`click`]],template:function(e,n){if(e&1&&(ki(0,`h4`,1)(1,`span`,2)(2,`span`,3),aT(3),wT(4,`date`),gl()(),ki(5,`span`,4)(6,`span`,5),aT(7),gl(),gw(8,wn,2,0,`mat-icon`,6)(9,Sn,2,0,`mat-icon`,7),ki(10,`button`,8)(11,`mat-icon`),aT(12,`more_vert`),gl()()()(),ki(13,`mat-menu`,null,0),Ah(15,Dn,5,0,`button`,9),ki(16,`button`,10),Xh(`click`,function(){return n.viewInTimeline()}),ki(17,`mat-icon`),aT(18,`play_circle`),gl(),ki(19,`span`),aT(20,`Relive in timeline`),gl()(),ki(21,`button`,10),Xh(`click`,function(){return n.shareJourney()}),ki(22,`mat-icon`),aT(23,`share`),gl(),ki(24,`span`),aT(25,`Share journey`),gl()()()),e&2){let i=Vw(14);gE(3),mg(bT(4,4,n.journey().journeyDate,`dd.MM.yyyy`)),gE(4),mg(n.journey().name),gE(),mw(n.journey().isPublished?8:9),gE(2),$h(`matMenuTriggerFor`,i)}},dependencies:[mt,C,yt$1,wt$1,Tn$1,Bt,Lt$1,I,G,Bt$1,ci],encapsulation:2})}}return a})();var Mn=()=>[];function Nn(a,s){a&1&&(ki(0,`mat-icon`),aT(1,`map`),gl(),ki(2,`span`,13),aT(3,`Geo`),gl())}function En(a,s){if(a&1&&(ki(0,`span`,14)(1,`mat-icon`,16),aT(2),gl(),aT(3),gl()),a&2){let t=Aw(2);Bh(`aria-label`,`Category: `+t.geoDetails?.category);let e=Aw().getIconConfigByCategory(t.geoDetails?.category);gE(2),Dl(` `,e?.iconName,` `),gE(),Dl(` `,e?.label,` `)}}function Bn(a,s){if(a&1&&(ki(0,`h6`,15),aT(1),gl()),a&2){let t=Aw(2);gE(),Dl(` `,t.geoDetails?.title,` `)}}function Rn(a,s){if(a&1&&(ki(0,`div`,8),gw(1,En,4,3,`span`,14),gw(2,Bn,2,1,`h6`,15),gl()),a&2){let t=Aw();gE(),mw(t.geoDetails?.category?1:-1),gE(),mw(t.geoDetails?.title?2:-1)}}function Pn(a,s){a&1&&(ki(0,`mat-icon`),aT(1,`bookmark_heart`),gl(),ki(2,`span`,13),aT(3,`Memories`),gl())}function Ln(a,s){a&1&&(ki(0,`mat-icon`),aT(1,`photo_library`),gl(),ki(2,`span`,13),aT(3,`Images`),gl())}function An(a,s){a&1&&(ki(0,`mat-icon`),aT(1,`video_library`),gl(),ki(2,`span`,13),aT(3,`Videos`),gl())}function Fn(a,s){if(a&1&&(ki(0,`section`,0)(1,`div`,1)(2,`div`,2),Uh(3,`app-view-journey-header`,3),gl()(),ki(4,`div`,4)(5,`mat-tab-group`,5)(6,`mat-tab`),Ah(7,Nn,4,0,`ng-template`,6),ki(8,`div`,7),gw(9,Rn,3,2,`div`,8),ki(10,`div`,9),Uh(11,`app-world-map`,10),gl()()(),ki(12,`mat-tab`),Ah(13,Pn,4,0,`ng-template`,6),ki(14,`div`,7),Uh(15,`app-view-journey-basic-details`,3),gl()(),ki(16,`mat-tab`),Ah(17,Ln,4,0,`ng-template`,6),ki(18,`div`,7),Uh(19,`app-media-gallery`,11),gl()(),ki(20,`mat-tab`),Ah(21,An,4,0,`ng-template`,6),ki(22,`div`,7),Uh(23,`app-media-gallery`,12),gl()()()()()),a&2){let t=s,e=Aw();gE(3),$h(`journey`,t),gE(6),mw(t.geoDetails?.category||t.geoDetails?.title?9:-1),gE(2),$h(`geoJsonData`,t.geoDetails?.geoJson||t.geoDetails?.location)(`iconType`,t.geoDetails?.category??e.DEFAULT_CATEGORY),gE(4),$h(`journey`,t),gE(4),$h(`images`,e.getImages(t))(`videos`,yT(8,Mn)),gE(4),$h(`videos`,e.getVideos(t))}}var bi=(()=>{class a{constructor(){this.route=w(G$1),this.journeyService=w(L$1),this.journey=F(this.journeyService.getJourneyById(this.route.snapshot.params.id),{initialValue:null}),this.DEFAULT_CATEGORY=b,this.getIconConfigByCategory=$o}getImages(t){return t.imagesDetails??new l}getVideos(t){let e=new Array;return t.videosDetails?.videos?.map(n=>e.push(n.videoId)),e}static{this.ɵfac=function(e){return new(e||a)}}static{this.ɵcmp=WD({type:a,selectors:[[`app-view-journey`]],decls:1,vars:1,consts:[[1,`mt-6`,`mb-4`],[1,`grid`,`grid-cols-1`,`gap-4`,`items-center`],[1,`col-span-1`],[3,`journey`],[1,`mt-6`],[`mat-stretch-tabs`,`true`,`mat-align-tabs`,`start`,1,`shadow-md`,`rounded-lg`],[`mat-tab-label`,``],[1,`p-4`],[1,`flex`,`flex-row`,`items-center`,`justify-center`,`gap-2`,`mb-3`],[1,`relative`,`h-[50vh]`,`md:h-[80vh]`,`rounded-lg`,`overflow-hidden`],[3,`geoJsonData`,`iconType`],[`galleryId`,`imageGallery`,3,`images`,`videos`],[`galleryId`,`videoGallery`,3,`videos`],[1,`ml-1`],[1,`inline-flex`,`items-center`,`gap-1.5`,`shrink-0`,`px-3`,`py-1`,`rounded-full`,`bg-primary/10`,`dark:bg-primary/20`,`border`,`border-primary/25`,`dark:border-primary/30`,`text-primary`,`text-xs`,`font-semibold`,`tracking-wide`,`select-none`],[1,`text-base`,`font-bold`,`gradient-text`,`m-0`,`truncate`],[1,`journey-card__icon--sm`,`shrink-0`,`opacity-80`]],template:function(e,n){if(e&1&&gw(0,Fn,24,9,`section`,0),e&2){let i;mw((i=n.journey())?0:-1,i)}},dependencies:[Ve,wt,wt$1,It,n4,Oe,Ge,Dt,ze],encapsulation:2})}}return a})();export{bi as ViewJourneyComponent};