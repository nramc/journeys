...
`],encapsulation:2})}return t})();var ki=(()=>{class t{static ɵfac=function(i){return new(i||t)};static ɵmod=bh({type:t});static ɵinj=Ks({imports:[ki$2]})}return t})();var mn=[[[`caption`]],[[`colgroup`],[`col`]],`*`];var un=[`caption`,`colgroup, col`,`*`];function hn(t,a){t&1&&Ow(0,2)}function fn(t,a){t&1&&(ki$1(0,`thead`,0),Gh(1,1),hl(),ki$1(2,`tbody`,2),Gh(3,3)(4,4),hl(),ki$1(5,`tfoot`,0),Gh(6,5),hl())}function pn(t,a){t&1&&Gh(0,1)(1,3)(2,4)(3,5)}var xi=(()=>{class t extends et{stickyCssClass=`mat-mdc-table-sticky`;needsPositionStickyOnElement=!1;static ɵfac=(()=>{let e;return function(n){return(e||(e=Iv(t)))(n||t)}})();static ɵcmp=WD({type:t,selectors:[[`mat-table`],[`table`,`mat-table`,``]],hostAttrs:[1,`mat-mdc-table`,`mdc-data-table__table`],hostVars:2,hostBindings:function(i,n){i&2&&lg(`mat-table-fixed-layout`,n.fixedLayout)},exportAs:[`matTable`],features:[mT([{provide:et,useExisting:t},{provide:L,useExisting:t},{provide:ye,useValue:null}]),Sh],ngContentSelectors:un,decls:5,vars:2,consts:[[`role`,`rowgroup`],[`headerRowOutlet`,``],[`role`,`rowgroup`,1,`mdc-data-table__content`],[`rowOutlet`,``],[`noDataRowOutlet`,``],[`footerRowOutlet`,``]],template:function(i,n){i&1&&(kw(mn),Ow(0),Ow(1,1),gw(2,hn,1,0),gw(3,fn,7,0)(4,pn,4,0)),i&2&&(gE(2),mw(n._isServer?2:-1),gE(),mw(n._isNativeHtmlTable?3:4))},dependencies:[Ke,Ye,Xe,Ze],styles:[`.mat-mdc-table-sticky {
