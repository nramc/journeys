import {D,G,cy as zt,b7 as fe,cz as se,aY as Ai,bM as U,cA as wt,bp as Dr,bG as N,cB as gi,bc as wu,cC as j,cD as oe,cE as Pt,aG as S,co as _r,A as AD,T as Tn,M as Mi,z as zw,l as ll,t as tw,c as tE,E as gl,n as nw,cF as tt,bu as se$1,aW as Mr,aU as T1,b5 as m$1,b9 as lr,aD as ie,bx as ge,bs as yp,bi as im,aO as Eh,bB as gi$1,b as wh,O as Oh,a$ as Rh,C as qh,aS as eg,bF as Qh,bm as ww,bn as Tw,aH as PD,B as uw,q as yw,H as cd,I as ld}from'./main-HBQVQ6DN.js';function pt(a,l){if(a&1){let t=uw();Mi(0,"div",1)(1,"button",2),qh("click",function(){cd(t);let n=yw();return ld(n.action())}),zw(2),ll()();}if(a&2){let t=yw();tE(2),gl(" ",t.data.action," ");}}var _t=["label"];function bt(a,l){}var kt=Math.pow(2,31)-1,_=class{_overlayRef;instance;containerInstance;_afterDismissed=new ie;_afterOpened=new ie;_onAction=new ie;_durationTimeoutId;_dismissedByAction=false;constructor(l,t){this._overlayRef=t,this.containerInstance=l,l._onExit.subscribe(()=>this._finishDismiss());}dismiss(){this._afterDismissed.closed||this.containerInstance.exit(),clearTimeout(this._durationTimeoutId);}dismissWithAction(){this._onAction.closed||(this._dismissedByAction=true,this._onAction.next(),this._onAction.complete(),this.dismiss()),clearTimeout(this._durationTimeoutId);}closeWithAction(){this.dismissWithAction();}_dismissAfter(l){this._durationTimeoutId=setTimeout(()=>this.dismiss(),Math.min(l,kt));}_open(){this._afterOpened.closed||(this._afterOpened.next(),this._afterOpened.complete());}_finishDismiss(){this._overlayRef.dispose(),this._onAction.closed||this._onAction.complete(),this._afterDismissed.next({dismissedByAction:this._dismissedByAction}),this._afterDismissed.complete(),this._dismissedByAction=false;}afterDismissed(){return this._afterDismissed}afterOpened(){return this.containerInstance._onEnter}onAction(){return this._onAction}},dt=new S("MatSnackBarData"),m=class{politeness="polite";announcementMessage="";viewContainerRef;duration=0;panelClass;direction;data=null;horizontalPosition="center";verticalPosition="bottom"},vt=(()=>{class a{static \u0275fac=function(e){return new(e||a)};static \u0275dir=PD({type:a,selectors:[["","matSnackBarLabel",""]],hostAttrs:[1,"mat-mdc-snack-bar-label","mdc-snackbar__label"]})}return a})(),yt=(()=>{class a{static \u0275fac=function(e){return new(e||a)};static \u0275dir=PD({type:a,selectors:[["","matSnackBarActions",""]],hostAttrs:[1,"mat-mdc-snack-bar-actions","mdc-snackbar__actions"]})}return a})(),gt=(()=>{class a{static \u0275fac=function(e){return new(e||a)};static \u0275dir=PD({type:a,selectors:[["","matSnackBarAction",""]],hostAttrs:[1,"mat-mdc-snack-bar-action","mdc-snackbar__action"]})}return a})(),xt=(()=>{class a{snackBarRef=D(_);data=D(dt);action(){this.snackBarRef.dismissWithAction();}get hasAction(){return !!this.data.action}static \u0275fac=function(e){return new(e||a)};static \u0275cmp=AD({type:a,selectors:[["simple-snack-bar"]],hostAttrs:[1,"mat-mdc-simple-snack-bar"],exportAs:["matSnackBar"],decls:3,vars:2,consts:[["matSnackBarLabel",""],["matSnackBarActions",""],["matButton","","matSnackBarAction","",3,"click"]],template:function(e,n){e&1&&(Mi(0,"div",0),zw(1),ll(),tw(2,pt,3,1,"div",1)),e&2&&(tE(),gl(" ",n.data.message,`
`),tE(),nw(n.hasAction?2:-1));},dependencies:[Tn,vt,yt,gt],styles:[`.mat-mdc-simple-snack-bar {
  display: flex;
}
