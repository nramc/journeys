...
`],encapsulation:2,changeDetection:1})}return a})(),Tt=class{index;tab};function yt(a){let r=a+"";return /^\d+$/.test(r)?a+"ms":r}var hn=(a,r)=>r.data?.src;function un(a,r){a&1&&zw(0," YouTube ");}function _n(a,r){a&1&&zw(0," Video ");}function fn(a,r){if(a&1&&(Mi(0,"span",5),tw(1,un,1,0)(2,_n,1,0),ll()),a&2){let t=yw().$implicit,e=yw();tE(),nw(t.type===e.GalleryItemTypes.Youtube?1:2);}}function gn(a,r){if(a&1&&(Mi(0,"div",1),Oh(1,"img",4),tw(2,fn,3,1,"span",5),ll()),a&2){let t=r.$implicit,e=r.$index,n=yw();kh("lightbox",e)("gallery",n.galleryId()),tE(),kh("src",t.type===n.GalleryItemTypes.Image?t.data?.src:t.data?.thumb??"assets/image/default-video-thumbnail.png",sp)("matTooltip",t.data?.args?.title),tE(),nw(t.type!==n.GalleryItemTypes.Image?2:-1);}}function vn(a,r){a&1&&(Mi(0,"p",2),zw(1," No media available for this journey. "),ll());}function yn(a,r){if(a&1&&(fl(0),Mi(1,"div",6)(2,"p",7),zw(3),ll()(),Gi()),a&2){let t=r.$implicit;tE(3),ag(t?.args?.title);}}var je=(()=>{class a{constructor(){this.GalleryItemTypes=z,this.galleryId=y1("myLightbox"),this.images=y1(new l),this.videos=y1([]),this.galleryImageDef=I1.required(Sn$1),this.gallery=D(Y),this.items=v1([]),this.galleryConfig={loadingStrategy:"lazy"};}ngOnInit(){this.items.set(this.getGalleryItems()),this.gallery.ref(this.galleryId(),U({imageTemplate:this.galleryImageDef().templateRef},this.galleryConfig)).load(this.items());}getGalleryItems(){let t=new Array;return this.getImageItems()?.map(e=>t.push(e)),this.getVideoItems()?.map(e=>t.push(e)),t}getImageItems(){return this.images()?.images.map(t=>({type:z.Image,data:{src:t.url,thumb:t.url,args:{title:t.title,isThumbnail:t.isThumbnail}}}))}getVideoItems(){return this.videos()?.map(t=>this.isItYoutubeVideoId(t)?this.newYoutubeItem(t):this.newVideoItem(t))}isItYoutubeVideoId(t){return !t.includes(".")&&!t.includes("/")}newYoutubeItem(t){return {type:z.Youtube,data:{src:`https://www.youtube.com/embed/${t}`,thumb:`https://img.youtube.com/vi/${t}/0.jpg`,params:{loop:1,playlist:t,rel:0,controls:1}}}}newVideoItem(t){return {type:z.Iframe,data:{src:t,thumb:"assets/image/default-video-thumbnail.png"}}}static{this.\u0275fac=function(e){return new(e||a)};}static{this.\u0275cmp=AD({type:a,selectors:[["app-media-gallery"]],viewQuery:function(e,n){e&1&&Yh(n.galleryImageDef,Sn$1,5),e&2&&Cw();},inputs:{galleryId:[1,"galleryId"],images:[1,"images"],videos:[1,"videos"],items:[1,"items"]},outputs:{items:"itemsChange"},decls:5,vars:1,consts:[[1,"flex","flex-wrap","grow","mt-2","me-0","gap-2","justify-center"],[1,"mb-1","text-center","rounded-lg","overflow-hidden","shadow-lg","border","border-gray-300",3,"lightbox","gallery"],[1,"text-gray-500","italic"],[4,"galleryImageDef"],["height","200","width","200","alt","media","loading","lazy",1,"journey-image-thumbnail",3,"src","matTooltip"],[1,"video-tag"],[1,"h-full","w-full","text-end","flex","flex-col","justify-end"],[1,"text-center"]],template:function(e,n){e&1&&(Mi(0,"div",0),ow(1,gn,3,5,"div",1,hn,false,vn,2,0,"p",2),ll(),wh(4,yn,4,1,"ng-container",3)),e&2&&(tE(),iw(n.items()));},dependencies:[Lr,Sn$1,Nr,Yt,mt],styles:[".journey-image-thumbnail[_ngcontent-%COMP%]{object-fit:fill}.mb-1.text-center.rounded-lg.overflow-hidden.shadow-lg.border.border-gray-300[_ngcontent-%COMP%]{position:relative}.video-tag[_ngcontent-%COMP%]{position:absolute;bottom:8px;right:8px;background:#ffffffb3;color:#4b5563;padding:4px 10px;border-radius:12px;font-size:11px;font-weight:500;-webkit-backdrop-filter:blur(4px);backdrop-filter:blur(4px)}"]});}}return a})();function Cn(a,r){if(a&1&&(Mi(0,"span",4),zw(1),ll()),a&2){let t=r.$implicit;tE(),gl(" ",t," ");}}var He=(()=>{class a{constructor(){this.journey=y1.required();}static{this.\u0275fac=function(e){return new(e||a)};}static{this.\u0275cmp=AD({type:a,selectors:[["app-view-journey-basic-details"]],inputs:{journey:[1,"journey"]},decls:6,vars:3,consts:[[1,"mt-4"],[1,"min-h-[50vh]"],[3,"title","markdownText","journeyDate"],[1,"mt-4","flex","flex-wrap","gap-2"],[1,"badge","rounded-full","border","border-primary","text-primary","px-3","py-1","shadow-sm"]],template:function(e,n){e&1&&(Mi(0,"div",0)(1,"div",1),Oh(2,"app-display-markdown-component",2),ll(),Mi(3,"div",3),ow(4,Cn,2,1,"span",4,rw),ll()()),e&2&&(tE(2),kh("title",n.journey().geoDetails?.title??"")("markdownText",n.journey().description)("journeyDate",n.journey().journeyDate),tE(2),iw(n.journey().tags));},dependencies:[Zn,pe],encapsulation:2});}}return a})();function xn(a,r){a&1&&(Mi(0,"mat-icon",5),zw(1,"check_circle"),ll());}function Tn(a,r){a&1&&(Mi(0,"mat-icon",6),zw(1,"remove_circle"),ll());}function kn(a,r){if(a&1){let t=uw();Mi(0,"button",9),qh("click",function(){cd(t);let n=yw();return ld(n.editJourney())}),Mi(1,"mat-icon"),zw(2,"edit"),ll()();}}var Ne=(()=>{class a{constructor(){this.router=D(ue),this.journey=y1.required();}editJourney(){this.router.navigate(["/journey",this.journey().id,"edit"]).then();}viewInTimeline(){this.router.navigate(["/timeline"],{queryParams:{id:this.journey().id,autoplay:"true"}}).then();}static{this.\u0275fac=function(e){return new(e||a)};}static{this.\u0275cmp=AD({type:a,selectors:[["app-view-journey-header"]],inputs:{journey:[1,"journey"]},decls:14,vars:6,consts:[[1,"flex","flex-col","md:flex-row","items-center","gap-4"],[1,"text-sm","text-primary","border-2","border-gradient-primary","badge","rounded-md","px-2","py-1"],[1,"journey-date"],[1,"flex","flex-row","items-center","gap-1"],[1,"text-lg","font-semibold","text-center"],["matTooltip","Published",1,"text-success!","!overflow-visible"],["matTooltip","Not Published",1,"text-warning!","!overflow-visible"],["mat-icon-button","","matTooltip","Edit Journey",3,"click",4,"appHasWriteAccess"],["mat-icon-button","","matTooltip","Relive in Timeline",3,"click"],["mat-icon-button","","matTooltip","Edit Journey",3,"click"]],template:function(e,n){e&1&&(Mi(0,"h4",0)(1,"span",1)(2,"span",2),zw(3),cT(4,"date"),ll()(),Mi(5,"span",3)(6,"span",4),zw(7),ll(),tw(8,xn,2,0,"mat-icon",5)(9,Tn,2,0,"mat-icon",6),wh(10,kn,3,0,"button",7),Mi(11,"button",8),qh("click",function(){return n.viewInTimeline()}),Mi(12,"mat-icon"),zw(13,"play_circle"),ll()()()()),e&2&&(tE(3),ag(dT(4,3,n.journey().journeyDate,"dd.MM.yyyy")),tE(4),ag(n.journey().name),tE(),nw(n.journey().isPublished?8:9));},dependencies:[mt,C,yt$1,wt$1,Fn,St,si],encapsulation:2});}}return a})();var In=()=>[];function wn(a,r){a&1&&(Mi(0,"mat-icon"),zw(1,"map"),ll(),Mi(2,"span",13),zw(3,"Geo"),ll());}function Dn(a,r){if(a&1&&(Mi(0,"span",14)(1,"mat-icon",16),zw(2),ll(),zw(3),ll()),a&2){let t=yw(2);Rh("aria-label","Category: "+t.geoDetails?.category);let e=yw().getIconConfigByCategory(t.geoDetails?.category);tE(2),gl(" ",e?.iconName," "),tE(),gl(" ",e?.label," ");}}function Mn(a,r){if(a&1&&(Mi(0,"h6",15),zw(1),ll()),a&2){let t=yw(2);tE(),gl(" ",t.geoDetails?.title," ");}}function En(a,r){if(a&1&&(Mi(0,"div",8),tw(1,Dn,4,3,"span",14),tw(2,Mn,2,1,"h6",15),ll()),a&2){let t=yw();tE(),nw(t.geoDetails?.category?1:-1),tE(),nw(t.geoDetails?.title?2:-1);}}function Bn(a,r){a&1&&(Mi(0,"mat-icon"),zw(1,"bookmark_heart"),ll(),Mi(2,"span",13),zw(3,"Memories"),ll());}function Rn(a,r){a&1&&(Mi(0,"mat-icon"),zw(1,"photo_library"),ll(),Mi(2,"span",13),zw(3,"Images"),ll());}function Pn(a,r){a&1&&(Mi(0,"mat-icon"),zw(1,"video_library"),ll(),Mi(2,"span",13),zw(3,"Videos"),ll());}function Sn(a,r){if(a&1&&(Mi(0,"section",0)(1,"div",1)(2,"div",2),Oh(3,"app-view-journey-header",3),ll()(),Mi(4,"div",4)(5,"mat-tab-group",5)(6,"mat-tab"),wh(7,wn,4,0,"ng-template",6),Mi(8,"div",7),tw(9,En,3,2,"div",8),Mi(10,"div",9),Oh(11,"app-world-map",10),ll()()(),Mi(12,"mat-tab"),wh(13,Bn,4,0,"ng-template",6),Mi(14,"div",7),Oh(15,"app-view-journey-basic-details",3),ll()(),Mi(16,"mat-tab"),wh(17,Rn,4,0,"ng-template",6),Mi(18,"div",7),Oh(19,"app-media-gallery",11),ll()(),Mi(20,"mat-tab"),wh(21,Pn,4,0,"ng-template",6),Mi(22,"div",7),Oh(23,"app-media-gallery",12),ll()()()()()),a&2){let t=r,e=yw();tE(3),kh("journey",t),tE(6),nw(t.geoDetails?.category||t.geoDetails?.title?9:-1),tE(2),kh("geoJsonData",t.geoDetails?.geoJson||t.geoDetails?.location)("iconType",t.geoDetails?.category??e.DEFAULT_CATEGORY),tE(4),kh("journey",t),tE(4),kh("images",e.getImages(t))("videos",rT(8,In)),tE(4),kh("videos",e.getVideos(t));}}var ri=(()=>{class a{constructor(){this.route=D(G),this.journeyService=D(L),this.journey=F(this.journeyService.getJourneyById(this.route.snapshot.params.id),{initialValue:null}),this.DEFAULT_CATEGORY=b,this.getIconConfigByCategory=$o;}getImages(t){return t.imagesDetails??new l}getVideos(t){let e=new Array;return t.videosDetails?.videos?.map(n=>e.push(n.videoId)),e}static{this.\u0275fac=function(e){return new(e||a)};}static{this.\u0275cmp=AD({type:a,selectors:[["app-view-journey"]],decls:1,vars:1,consts:[[1,"mt-6","mb-4"],[1,"grid","grid-cols-1","gap-4","items-center"],[1,"col-span-1"],[3,"journey"],[1,"mt-6"],["mat-stretch-tabs","true","mat-align-tabs","start",1,"shadow-md","rounded-lg"],["mat-tab-label",""],[1,"p-4"],[1,"flex","flex-row","items-center","justify-center","gap-2","mb-3"],[1,"relative","h-[50vh]","md:h-[80vh]","rounded-lg","overflow-hidden"],[3,"geoJsonData","iconType"],["galleryId","imageGallery",3,"images","videos"],["galleryId","videoGallery",3,"videos"],[1,"ml-1"],[1,"inline-flex","items-center","gap-1.5","shrink-0","px-3","py-1","rounded-full","bg-primary/10","dark:bg-primary/20","border","border-primary/25","dark:border-primary/30","text-primary","text-xs","font-semibold","tracking-wide","select-none"],[1,"text-base","font-bold","gradient-text","m-0","truncate"],[1,"journey-card__icon--sm","shrink-0","opacity-80"]],template:function(e,n){if(e&1&&tw(0,Sn,24,9,"section",0),e&2){let i;nw((i=n.journey())?0:-1,i);}},dependencies:[Fe,wt,wt$1,It,n4,je,He,Ot,Ne],encapsulation:2});}}return a})();
