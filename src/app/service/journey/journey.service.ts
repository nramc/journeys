...
import {Journey, JourneyImageDetails} from "../../model/core/journey.model";
...
export class JourneyService {
  ...
  saveJourneyImagesDetails(journey: Journey, imagesDetails: JourneyImageDetails): Observable<Journey> {
